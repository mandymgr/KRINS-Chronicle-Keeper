...
echo "🌟 === KRINS CHRONICLE-KEEPER SEMANTIC SEARCH SETUP ==="
echo "Setting up PostgreSQL with pgvector for organizational intelligence..."
echo
...
# Configuration for Chronicle-Keeper
DB_NAME="krins_db"
DB_USER="krinschron"
