...
const { memory: proactiveMemory } = require('./src/proactive-memory');
...
async function loadKrinMemories() {
  ...
  try {
    ...
    if (summary.success) {
      ...
      await proactiveMemory.initialize();
      ...
      await proactiveMemory.createBackupPoint('Session initialized with enhanced memory strategy');
